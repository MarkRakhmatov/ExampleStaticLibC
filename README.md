...
[![ci](https://github.com/MarkRakhmatov/ExampleStaticLibC/actions/workflows/ci.yml/badge.svg)](https://github.com/MarkRakhmatov/ExampleStaticLibC/actions/workflows/ci.yml)

## About ExampleStaticLibC
...
### Usage
#### CMake
To use ExampleStaticLibC library in cmake project:

```
CPMAddPackage("gh:MarkRakhmatov/ExampleStaticLibC@v0.1.0")
```

Link ExampleStaticLibC library to your target
```
target_link_libraries(your_target PRIVATE ExampleStaticLibC)
```
